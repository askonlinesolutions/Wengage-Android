...
public class GetContatctModal {
    ...
    public static class ContactsListBean {
        private List<MyInvitationsBean> myInvitations;
        private List<MyContactsBean> myContacts;

        public List<MyInvitationsBean> getMyInvitations() {
            return myInvitations;
        }

        public void setMyInvitations(List<MyInvitationsBean> myInvitations) {
            this.myInvitations = myInvitations;
        }

        public List<MyContactsBean> getMyContacts() {
            return myContacts;
        }

        public void setMyContacts(List<MyContactsBean> myContacts) {
