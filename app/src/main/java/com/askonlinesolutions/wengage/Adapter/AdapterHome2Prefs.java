 ...
 */
public class AdapterHome2Prefs extends RecyclerView.Adapter<AdapterHome2Prefs.MyViewHolder> {

    private List<EventCategoryModal> preferences;
    private Interface_Home_2_Pref click;
    private Context context;

    public AdapterHome2Prefs(List<EventCategoryModal> preferences,
