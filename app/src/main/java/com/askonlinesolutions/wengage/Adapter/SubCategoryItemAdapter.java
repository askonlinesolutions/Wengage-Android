...
public class SubCategoryItemAdapter extends RecyclerView.Adapter<SubCategoryItemAdapter.MyViewHolder> {

    List<VenueSubCategoryListBean> subCategoryLists;
    Context context;
    ...
    public SubCategoryItemAdapter(Context context, List<VenueSubCategoryListBean> subCategoryList,
                                  List<ItemClickStatusModel> itemClickStatusModelList,
