...
public class EventRatingAdapter extends RecyclerView.Adapter<EventRatingAdapter.MyViewHolder> {
    ...
    private List<EventDetailEventResponse.EventDataBean.RatingsBean> ratingsBeans;

    public EventRatingAdapter(Context context, List<EventDetailEventResponse.EventDataBean.RatingsBean> ratingsBeans) {
