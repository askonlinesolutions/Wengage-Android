 ...
 */
public class InterestedUserAdapter extends RecyclerView.Adapter<InterestedUserAdapter.MyViewHolder> {

    private Context context;
    List<VenueDetailsResponse.VenueDataBean.InterestedUsersBean> interestedUsers;

    public InterestedUserAdapter(Context context, List<VenueDetailsResponse.VenueDataBean.InterestedUsersBean> interestedUsers) {
